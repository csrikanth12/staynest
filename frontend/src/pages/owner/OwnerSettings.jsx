...
const OwnerSettings = () => {
  ...
  const handleSettingsSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        updateUser(res.data);
        setMessage('Owner account details updated successfully!');
        setPassword('');
        setConfirmPassword('');
      }
    } catch (err) {
  ...
  return (
    <div className="owner-settings-page pb-5">
      <BackButton />

      {/* Header */}
      <div className="d-flex flex-column flex-md-row md-align-items-center justify-content-between mb-4 gap-3">
        <div>
          <h2 className="fw-bold text-dark mb-1">Hostel Owner Settings</h2>
          <p className="text-muted small mb-0">Manage your property manager profile and account security</p>
        </div>
      </div>

      <div className="bg-white p-4 p-md-5 rounded-4 border shadow-sm" style={{ maxWidth: '800px' }}>
        {/* Profile Card Header */}
        <div className="d-flex align-items-center gap-3 pb-4 border-bottom mb-4">
          ...
          <div>
            <div className="d-flex align-items-center gap-2 mb-1">
              ...
              <span className="badge bg-primary text-white rounded-pill text-uppercase small">
                Hostel Owner
              </span>
            </div>
        ...
        <form onSubmit={handleSettingsSubmit}>
          <h5 className="fw-bold text-dark mb-3">Owner Contact Details</h5>

          <div className="row g-3 mb-4">
            <div className="col-md-6">
              <label className="form-label small fw-bold text-dark">Manager Name</label>
            ...
            <div className="col-md-6">
              <label className="form-label small fw-bold text-dark">Business Phone Number</label>
              <div className="input-group">
                <span className="input-group-text bg-light text-muted">
                  <Phone size={16} />
                </span>
            ...
            <div className="col-md-6">
              <label className="form-label small fw-bold text-dark">Profile Avatar URL</label>
              <div className="input-group">
                <span className="input-group-text bg-light text-muted">
                  <Camera size={16} />
                </span>
          ...
          <p className="text-muted small mb-3">Change your portal login password</p>
